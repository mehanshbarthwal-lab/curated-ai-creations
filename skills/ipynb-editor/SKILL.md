...
## Script Location
The editor script is located at:
`F:\Agent Skills\ipynb-editor\scripts\notebook_editor.py`
...
```bash
python "F:\Agent Skills\ipynb-editor\scripts\notebook_editor.py" list <notebook.ipynb>
```

### 2. Read a Cell
Read the contents of a specific cell (with line numbers, helpful for patching).
```bash
python "F:\Agent Skills\ipynb-editor\scripts\notebook_editor.py" read <notebook.ipynb> <cell_index> --numbered
```
...
```bash
python "F:\Agent Skills\ipynb-editor\scripts\notebook_editor.py" update <notebook.ipynb> <cell_index> --from-file <temp_file.py>
```
...
```bash
python "F:\Agent Skills\ipynb-editor\scripts\notebook_editor.py" patch <notebook.ipynb> <cell_index> --lines <start_line>-<end_line> --from-file <patch.py>
```

### 5. Search Notebook
Find a specific string or function across the entire notebook.
```bash
python "F:\Agent Skills\ipynb-editor\scripts\notebook_editor.py" search <notebook.ipynb> "import torch"
```
